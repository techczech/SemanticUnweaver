...
export const SAMPLE_NOVEL = `# Psmith, Journalist By Pelham Grenville Wodehouse
...
"Sure thing," assented Master Maloney. He strolled slowly out, while Billy Windsor, mounting a chair, proceeded to chirrup and snap his fingers in the effort to establish the foundations of an _entente cordiale_ with the rescued cat.
...
"_Cosy Moments_?" said Psmith reflectively. "I regret that the bright little sheet has not come my way up to the present. I must seize an early opportunity of perusing it."
...
"Luella Granville Waterman," he said, "is not by any chance your _nom-de-plume_, Comrade Windsor?"
...
"Comrade Windsor, you have touched the spot. You are wasting the golden hours of your youth. You must move. You must hustle. You must make Windsor of _Cosy Moments_ a name to conjure with. You must boost this sheet up till New York rings with your exploits. On the present lines that is impossible. You must strike out a line for yourself. You must show the world that even _Cosy Moments_ cannot keep a good man down."
...
The offices of _Cosy Moments_ were in a large building in the street off Madison Avenue. They consisted of a sort of outer lair, where Pugsy Maloney spent his time reading tales of life in the prairies and heading off undesirable visitors; a small room, which would have belonged to the stenographer if _Cosy Moments_ had possessed one; and a larger room beyond, which was the editorial sanctum.
...
"And what more _could_ you have said?" agreed Psmith approvingly. "Tell me, Comrade Maloney, what was the general average aspect of these determined spirits?"
...
Rattling on, he was alluding to the prominent part _Cosy Moments_ had played in the affair, when a rough thrust from Windsor's elbow brought home to him his indiscretion.
...
"In-ter-_doo_\-cin' Young Leary," he bellowed impressively, "a noo member of this chub, who will box some good boy here in September."
...
"_Cosy Moments_ wins," said Psmith. "An omen, I fancy, Comrade Windsor."
...
"And why did I feel like that, Comrade Brady? I will tell you. Because my faith in you was justified. Because there before me stood the ideal fighting-editor of _Cosy Moments_. It is not a post that any weakling can fill. There charm of manner cannot qualify a man for the position. No one can hold down the job simply by having a kind heart or being good at farmyard imitations. No. We want a man of thews and sinews, a man who would rather be hit on the head with a half-brick than not. And you, Comrade Brady, are such a man."
...
"It is our friend of the earlier part of the evening, Comrade Windsor," said Psmith. "The merchant with whom we hob-nobbed on our way to the Highfield. In a moment of imprudence I mentioned _Cosy Moments_. I fancy that this was his first intimation that we were in the offing. His visit to the Highfield was paid, I think, purely from sport-loving motives. He was not on our trail. He came merely to see if Comrade Brady was proficient with his hands. Subsequent events must have justified our fighting editor in his eyes. It seems to be a moot point whether he will ever recover consciousness."
...
It soon became apparent that the light of the lamp, though bestowing the doubtful privilege of a clearer view of Mr. Repetto's face, held certain disadvantages. Scarcely had the staff of _Cosy Moments_ reached the faint yellow pool of light, in the centre of which Mr. Repetto reclined, than, with a suddenness which caused them to leap into the air, there sounded from the darkness down the road the _crack-crack-crack_ of a revolver. Instantly from the opposite direction came other shots. Three bullets flicked grooves in the roadway almost at Billy's feet. The Kid gave a sudden howl. Psmith's hat, suddenly imbued with life, sprang into the air and vanished, whirling into the night.
...
"That," said Psmith, nodding, "is a very fair _pricis_ of the evening's events. We should like you, if you will be so good, to corral this Comrade Repetto, and see that he buys me a new hat."
...
But the days went by without any further movement on the part of the enemy. A strange quiet seemed to be brooding over the other camp. As a matter of fact, the sudden outbreak of active hostilities with the Table Hill contingent had had the effect of taking the minds of Spider Reilly and his warriors off _Cosy Moments_ and its affairs, much as the unexpected appearance of a mad bull would make a man forget that he had come out butterfly-hunting. Psmith and Billy could wait; they were not likely to take the offensive; but the Table Hillites demanded instant attention.
...
"_Cosy Moments_, Comrade Gooch," Psmith replied. "Immediately behind you, between you and the door, is Comrade Windsor, our editor. I am Psmith. I sub-edit."
...
The chief editor of _Cosy Moments_ was seated on a bench, looking upon the world through a pair of much blackened eyes. His general appearance was dishevelled. He had the air of a man who has been caught in the machinery.
...
"For thirty days," sighed Psmith. "What _Cosy Moments_ really needs is a _sitz-redacteur_."

"A what?"

"A _sitz-redacteur_, Comrade Windsor, is a gentleman employed by German newspapers with a taste for _lhse majesti_ to go to prison whenever required in place of the real editor. The real editor hints in his bright and snappy editorial, for instance, that the Kaiser's moustache reminds him of a bad dream. The police force swoops down en masse on the office of the journal, and are met by the _sitz-redacteur_, who goes with them peaceably, allowing the editor to remain and sketch out plans for his next week's article on the Crown Prince. We need a _sitz-redacteur_ on _Cosy Moments_ almost as much as a fighting editor; and we have neither."
...
Mr. Jarvis was as good as his word. On the following morning, at ten o'clock to the minute, he made his appearance at the office of _Cosy Moments_, his fore-lock more than usually well oiled in honour of the occasion, and his right coat-pocket bulging in a manner that betrayed to the initiated eye the presence of the faithful "canister." With him, in addition to his revolver, he brought a long, thin young man who wore under his brown tweed coat a blue-and-red striped jersey. Whether he brought him as an ally in case of need or merely as a kindred soul with whom he might commune during his vigil, was not ascertained.
...
"You are absolutely correct, Comrade Parker. I do. Now that _Cosy Moments_ has our excellent friend Comrade Jarvis on its side, are you not to a certain extent among the Blenheim Oranges? I think so. I think so."
...
A feeling of regret for the futility of the thing was Psmith's first emotion. Billy could be of no possible help in the campaign at its present point. All the work that remained to be done could easily be carried through without his assistance. And by breaking out from the Island he had committed an offence which was bound to carry with it serious penalties. For the first time since his connection with _Cosy Moments_ began Psmith was really disturbed.
...
He picked up the current number of _Cosy Moments_, and turned to the Kid's page.
...
"_Cosy Moments_," said Mr. Wilberfloss irately, "is no medium for exploiting low prize-fighters."
...
"The proprietor?" gasped Mr. Wilberfloss. "Does _he_ know how you have treated the paper?"
...
export const SAMPLE_CSV = `Respondent_ID,Overall_Satisfaction,Keynote_Quality,Research_Presentations_Quality,Poster_Quality,Workshop_Quality,Venue_Rating,Networking_Opportunities,Relevance_to_Work,Likelihood_to_Recommend,Session_Attended_Most_Valuable,What_Worked_Well,What_Could_Improve,Additional_Comments
001,5,5,5,4,5,5,4,5,5,AI-Driven Solutions keynote,"Dr. Pollinator's keynote was transformative. The case studies showing 40% reduction in colony losses through AI monitoring were exactly what I needed for my research proposal. The integration of satellite imagery with IoT sensors opened new possibilities I hadn't considered.","More time for Q&A after keynotes. The 15 minutes wasn't enough given the audience interest.","Outstanding conference. The blend of technical depth and practical application was perfect."
002,4,5,4,4,3,4,4,4,4,Machine Learning Revolution keynote,"Prof. Hive's presentation on acoustic analysis was brilliant. The 40% reduction in colony losses is impressive and the methodology seems robust.","Workshop on building monitoring systems felt rushed. We needed at least another hour to properly understand the implementation.","Would have appreciated more breaks between sessions."
003,2,3,2,3,2,2,3,3,2,Deep Learning Models presentation,"Some interesting ideas about species classification, but overall disappointed.","Too much focus on honeybees, not enough on solitary bees and other pollinators. The conference title promised 'pollinators' but 80% of content was about Apis mellifera. Also, ethical concerns about AI energy consumption were barely addressed except in the closing keynote.","Expected more critical discussion of AI limitations. Most presentations felt like uncritical tech evangelism."
004,5,5,5,5,4,5,5,5,5,Federated Learning presentation,"Dr. Tanaka's work on global collaboration while preserving data privacy is exactly what our international consortium needs. The 92% accuracy across different subspecies demonstrates real practical value.","Nothing major. Perhaps more technical documentation available as handouts.","Excellent organization. The mix of disciplines created fascinating conversations."
005,4,4,4,3,4,4,5,4,4,Blockchain for conservation funding,"Prof. Johnson's blockchain platform is genuinely innovative. The $2.3 million facilitated with 75% lower transaction costs than traditional grants could revolutionize conservation funding.","Some presentations were too technical for non-computer scientists. Would benefit from parallel tracks for different expertise levels.","Networking opportunities were fantastic. Made three potential collaborators."
006,3,4,3,3,2,3,3,3,3,Reinforcement Learning for habitat design,"Dr. Roberts' habitat optimization work showed promise, but I'm skeptical about transferability.","The workshops needed more advanced options. The 'hands-on training' was too basic for researchers already working with AI. Also, no discussion of what happens when AI recommendations conflict with local ecological knowledge.","Food options were limited for dietary restrictions."
007,5,5,5,4,5,4,4,5,5,Natural Language Processing for research mining,"Dr. Thompson's NLP pipeline that analyzed 45,000 publications is a game-changer for systematic reviews. The finding that solitary bee decline preceded honeybee collapse by 3.2 years is crucial for conservation priorities.","More time for poster sessions. Felt rushed trying to see everything.","This conference significantly influenced my research direction."
008,4,4,4,4,5,4,4,4,4,Ethical AI Development workshop,"The ethics workshop was the highlight - addressed questions others avoided.","More critical voices needed. Too many presentations assumed AI is always the solution. Where were the presentations questioning whether computational approaches are appropriate for all conservation questions?","Dr. Ethics First's workshop should have been longer."
009,1,2,2,1,1,3,2,2,1,None particularly,"Deeply troubled by this conference's direction.","The entire framing is problematic. We're discussing billion-dollar AI solutions while local beekeepers with traditional knowledge are ignored. Prof. Johnson's blockchain talk mentioned Kenya, Brazil, Romania but no speakers from those countries? The colonial dynamics of 'developed nations solving problems for the developing world' went completely unexamined. Also, no discussion of whether pollinators need AI or if they need us to stop destroying their habitats.","Will not attend future iterations unless fundamental approach changes."
010,5,5,4,5,5,5,5,5,5,Computer Vision for Varroa detection,"Dr. Park's automated mite detection achieving 96% accuracy while reducing treatments by 60% is exactly what commercial beekeepers need.","Nothing significant. Very well organized.","Best conference I've attended in five years."
011,4,4,5,4,3,4,4,4,4,Time Series Forecasting presentation,"Prof. O'Connor's 14-day advance predictions with 82% accuracy could transform agricultural planning.","Venue WiFi was inconsistent. Made it difficult to access supplementary materials during presentations.","Appreciated the diversity of application domains."
012,3,3,3,4,3,3,4,3,3,Smartphone App poster,"Citizen science app seems useful but concerned about data quality.","Many posters were just preliminary results. Would prefer seeing more mature research. Also, several presenters weren't at their posters during designated times.","Average conference. Some good ideas but nothing groundbreaking."
013,5,5,5,5,5,5,4,5,5,AI Ethics keynote by Dr. Ecosystem,"Finally! Dr. Ecosystem's closing keynote addressed the elephant in the room - energy consumption of AI models and algorithmic bias. Her framework for equitable access and respect for indigenous knowledge should be required reading.","This keynote should have been FIRST, not last. Would have framed all other presentations differently.","Brilliant ending. Wish the whole conference maintained that critical perspective."
014,4,5,4,4,4,4,5,4,4,Genetic Algorithm for urban planning,"Dr. Martinez's Barcelona implementation showing 65% improvement in habitat connectivity is impressive real-world validation.","Coffee breaks too short. Conversations were just getting started when next session began.","Good balance of theory and practice."
015,2,3,2,2,2,2,2,3,2,Drone surveys presentation,"Dr. Hassan's autonomous drones are interesting but seems like overkill.","Question whether we need expensive drone fleets or if we should fund more human field researchers. The conference seemed dazzled by technological sophistication without adequately questioning cost-effectiveness or necessity. Also, no discussion of drone disturbance to wildlife.","Left feeling technology is driving research questions rather than ecological needs driving technology."
016,5,4,5,5,4,5,5,5,5,Pesticide Risk Assessment models,"Dr. Kim's models predicting toxicity with R²=0.91 and identifying synergistic interactions could save countless colonies.","More opportunities for informal discussion. The structured format limited spontaneous collaboration.","Met researchers I've cited for years. Invaluable networking."
017,4,4,4,4,5,4,4,4,4,Data Standards workshop,"Prof. Data Standard's workshop on database interoperability addressed critical infrastructure needs. The Darwin Core extensions for pollinators will help our lab enormously.","Some research presentations tried to cover too much. Would prefer deeper dives into fewer topics.","Workshops were the strongest part of the conference."
018,3,4,3,3,3,4,3,3,3,Pollen Analysis presentation,"Dr. Green's automated pollen identification is clever but limited scope.","Poster sessions too crowded. Couldn't have meaningful conversations. Also, several presentations had methodology issues that weren't addressed in the brief Q&A time.","Decent but not remarkable."
019,5,5,5,4,5,5,5,5,5,Building International Networks workshop,"Prof. Network Builder's workshop was exactly what I needed. Formed concrete research partnership with team from Australia.","Perhaps parallel sessions for some workshops so attendees can choose based on interests.","Exceeded expectations. Already drafting collaborative proposals."
020,4,4,4,4,4,3,4,4,4,Neural Network for bee dance analysis,"Prof. Foster's dance decoding work at 93% accuracy is fascinating. The discovery of dance dialects and communication disruption preceding collapse has major implications.","Venue temperature control inconsistent. Some rooms uncomfortably warm.","Solid conference with good content."
021,2,3,3,2,1,3,3,2,2,Hands-on workshop,"Disappointed by the hands-on workshop - too elementary.","The workshop promised 'building your first monitoring system' but was really just installing software and running example code. Needed actual hardware to work with, not just slides about Raspberry Pi. Also, no follow-up materials actually provided despite promises.","Would not recommend to colleagues doing serious AI research."
022,5,5,5,5,5,5,4,5,5,Keynotes in general,"All three keynotes were exceptional. Different perspectives that complemented each other perfectly.","More dedicated time for meeting potential collaborators. Speed networking session would be useful.","Planning to implement several ideas in our lab immediately."
023,4,4,4,3,4,4,4,4,4,IoT Predictive Analytics,"Prof. Mueller's system predicting collapse 3 weeks in advance with 89% accuracy could revolutionize beekeeping.","Registration process was cumbersome. Took 20 minutes to check in.","Good value for registration fee."
024,3,3,3,3,3,3,3,3,3,Various presentations,"Learned some useful things but nothing transformative.","Conference felt somewhat unfocused. Trying to cover too much ground between basic bee biology, advanced ML methods, policy, and ethics. Would benefit from clearer thematic organization or tracks.","Adequate but won't prioritize attending next time."
025,5,5,4,5,5,4,5,5,5,Queen Bee Health Assessment poster,"Dr. Royal's system detecting failing queens 3 weeks early is exactly what our operation needs. The 91% accuracy is better than human inspectors.","None. Excellent event.","Will definitely attend future conferences in this series."
026,4,5,4,4,3,4,4,5,4,Keynotes and ethics discussions,"Appreciated presentations acknowledging limitations and uncertainties rather than overselling AI capabilities.","More vegetarian food options. Lunch choices were limited.","Strong content, minor logistical issues."
027,1,2,1,2,1,2,2,1,1,None,"Extremely disappointed and honestly angry.","This conference exemplifies everything wrong with 'AI for good' initiatives. Millions spent on developing sophisticated models while simultaneously ignoring that: (1) pesticide regulations would save more bees than any AI system, (2) habitat restoration doesn't need machine learning, (3) the real barriers are political will and corporate interests, not insufficient technology. The $2.3M facilitated through blockchain mentioned in one talk could have directly funded habitat restoration. Instead we're building complex systems to monitor decline rather than addressing causes. Plus the carbon footprint of flying 100+ researchers to Oxford to discuss AI models that themselves have substantial environmental costs - the irony is painful.","Fundamentally misguided approach to conservation."
028,5,5,5,5,4,5,5,5,5,Machine Learning keynote,"Prof. Hive's multimodal sensor fusion achieving 40% colony loss reduction and 25% honey production increase demonstrates clear real-world impact.","Could use more case study details in presentations - implementation challenges, costs, failure modes.","Inspired multiple new research directions for our team."
029,4,4,4,4,4,4,4,4,4,Wing Morphometry poster,"Dr. Wing Analyst's automated subspecies ID at 94% accuracy would be valuable for our breeding program.","Some presentations moved too quickly through technical details. Could benefit from supplementary technical reports.","Good networking, good science."
030,3,4,3,3,2,3,3,3,3,Several research talks,"Mixed feelings about practical applicability.","Many impressive accuracy numbers but insufficient discussion of generalization. Models trained on European data - will they work in Africa? Asia? South America? Also very little discussion of failure modes or what happens when models are wrong in conservation contexts.","Some good ideas but concerned about hype versus reality."
031,5,5,5,4,5,5,5,5,5,Pesticide models and ethics keynote,"The combination of Dr. Kim's toxicity prediction models and Dr. Ecosystem's ethics framework shows the right way forward.","More time for the ethics discussions. This is where the real challenges lie.","Conference did an excellent job balancing technical advancement with ethical responsibility."
032,4,4,4,4,5,4,4,4,4,Collaborative Research workshop,"Workshop on building international networks was extremely practical. Left with actual collaboration agreements in draft form.","Parallel sessions meant missing interesting talks. Perhaps extend to 4 days to avoid conflicts.","Workshops provided most value for me."
033,2,3,2,3,2,3,2,2,2,Computer vision presentations,"Skeptical of many claims about accuracy.","Too many presentations lacked proper validation. Testing on held-out data from the same dataset isn't sufficient - need testing across different geographic regions, times, equipment. Several claimed 'ready for deployment' when they're clearly still early research. Also concerning that most teams don't include ecologists - just computer scientists working with bee images.","Needed more rigorous peer review before acceptance."
034,5,5,5,5,5,4,5,5,5,All keynotes,"Three keynotes together provided comprehensive view from technology through implementation to ethics.","None of substance. Extremely well done.","Career-changing conference. Thank you to organizers."
035,4,4,4,3,4,4,5,4,4,Social Network Analysis poster,"Prof. Network Mapper's RFID tracking revealing 15% of workers doing 60% of discoveries is fascinating social network dynamics.","Poster session timing conflicted with workshop I wanted to attend. Should be on different days.","Made valuable connections with researchers in complementary fields."
036,3,3,3,3,3,3,3,3,3,Various sessions,"Solid conference but not exceptional.","Nothing terrible but nothing outstanding either. Content felt somewhat repetitive - multiple presentations on similar topics with incremental differences. Could benefit from more synthesis talks bringing together related work.","Reasonable professional development opportunity."
037,5,5,4,5,4,5,4,5,5,Federated learning and blockchain talks,"The intersection of privacy-preserving AI and transparent funding mechanisms opens exciting possibilities for global collaboration.","More technical deep-dives in workshops. The ethical workshop was great but wanted more on technical implementation.","Intellectually stimulating and practically useful."
038,4,5,4,4,3,4,4,4,4,Opening keynote,"Dr. Pollinator's comprehensive overview set excellent context for the conference.","Schedule was exhausting. Back-to-back sessions from 9am-6pm with short breaks. Needed more downtime for processing and informal discussion.","Good content but grueling pace."
039,2,2,3,2,2,3,3,2,2,Edge computing poster,"Some interesting work but overall disappointing.","Quality was inconsistent. Some presentations were excellent while others seemed undergraduate-level work. Also noticed several instances of overstatement - 'revolutionary', 'game-changing', 'unprecedented' used too liberally. The edge computing poster, for example, claimed 'breakthrough' for essentially implementing existing algorithms on Raspberry Pi.","Would recommend more selective acceptance criteria."
040,5,5,5,5,5,5,5,5,5,Everything - particularly integrated approach,"This conference achieved something rare - genuine interdisciplinary dialogue.","Keep doing what you're doing. Maybe add mentorship program connecting students with established researchers.","Best conference I've attended. Will recommend widely."
041,4,4,4,4,4,4,4,4,4,Drone surveys and habitat design,"The combination of autonomous monitoring and optimized habitat design represents powerful integrated approach.","More opportunities to see actual technology demos. Several presenters mentioned systems but we only saw slides and videos.","Valuable professional development."
042,3,4,3,3,3,3,3,3,3,NLP literature mining,"Dr. Thompson's work extracting patterns from 45,000 papers is useful tool but limited insight.","Many presentations felt like 'we applied standard ML method X to bee problem Y'. Would appreciate more innovation in methods rather than just new applications of existing techniques.","Decent networking opportunity."
043,5,5,5,4,5,4,5,5,5,Queen assessment and mite detection posters,"The practical applications demonstrated in poster session could transform commercial beekeeping.","Extend poster sessions. Too much excellent work to see in limited time.","Posters often more interesting than formal talks - more honest about limitations and challenges."
044,4,4,4,4,5,4,4,4,4,Ethics workshop,"Dr. Ethics First facilitated nuanced discussion of difficult questions without easy answers.","Conference app was buggy. Kept losing schedule and connection.","Ethics workshop was absolute highlight."
045,1,2,2,1,1,2,2,2,1,None stood out positively,"Waste of time and money.","Fundamental disconnect between conference content and actual conservation needs. We don't need AI to know that: pesticides kill bees, monoculture farming eliminates habitat, climate change disrupts phenology, intensive agriculture is the problem. Yet somehow we're supposed to believe that sophisticated monitoring systems are the solution? It's techno-solutionism at its worst. Several talks mentioned 'stakeholder engagement' but I didn't see any actual beekeepers or indigenous land managers presenting. Just academics and tech companies.","Will actively discourage colleagues from attending."
046,5,5,5,5,4,5,4,5,5,Time series forecasting and IoT monitoring,"Prof. O'Connor's forecasting combined with Prof. Mueller's IoT system provides comprehensive monitoring and prediction capability.","More diversity in geography. Most case studies from US and Europe.","Excellent science and useful networking."
047,4,4,4,3,4,4,5,4,4,International Networks workshop,"Workshop facilitating actual partnership formation rather than just discussion was refreshing.","Some presentations had too many authors listed - clearly consortium projects but only one presenter. Would be interesting to hear different perspectives from large teams.","Valuable connections made."
048,3,3,3,3,3,3,3,3,3,Thermal imaging poster,"Decent work but incremental rather than transformative.","Sessions ran late, causing domino effect on schedule. Better time management needed.","Adequate conference."
049,5,5,4,5,5,5,5,5,5,Acoustic monitoring approaches,"The convergence of multiple teams using acoustic analysis from different angles (colony health, nesting activity, communication) suggests this is a promising direction.","None significant. Well organized and intellectually rewarding.","Will incorporate acoustic methods into our work based on what I learned."
050,4,5,4,4,4,4,4,5,4,Machine learning keynote,"Prof. Hive's comprehensive coverage of ML applications provided excellent overview.","Food service during breaks was slow. Long queues meant little actual break time.","Strong technical content."
051,2,3,2,2,2,3,2,3,2,Blockchain presentation,"Prof. Johnson's blockchain work seems like solution in search of problem.","The blockchain presentation felt out of place. Conservation funding doesn't need blockchain - it needs money and political will. This seemed more about showcasing trendy technology than solving actual problems. Also, no discussion of blockchain's energy consumption is ironic at a conservation conference.","Several presentations prioritized novelty over utility."
052,5,5,5,5,5,5,5,5,5,Ethics keynote and workshop,"Dr. Ecosystem's ethics framework should be required for all AI conservation work.","Make ethics central rather than closing topic. Should frame entire conference.","Transformative. Changed how I think about technology in conservation."
053,4,4,4,4,4,4,4,4,4,Species classification and habitat design,"Multiple presentations showing AI discovering non-intuitive patterns humans missed demonstrates genuine value-add.","More structured networking. Name badges with research interests would help.","Good balance of technical rigor and accessibility."
054,3,4,3,3,3,3,3,3,3,Keynotes primarily,"Keynotes were excellent but research presentations variable.","Inconsistent presentation quality. Some speakers clearly unrehearsed. Conference should provide presentation coaching or stricter review of practice talks.","Keynotes worth the trip; research sessions less so."
055,5,5,5,4,5,4,5,5,5,Varroa detection and pesticide models,"Dr. Park's mite detection and Dr. Kim's toxicity models address two biggest beekeeping challenges.","Venue location difficult to reach from train station. Better signage or shuttle would help.","Excellent practical applications that will benefit industry immediately."
056,4,4,4,4,5,4,4,4,4,All workshops,"Workshop format worked much better than lectures for complex topics.","Conference should continue for fourth day with just workshops and collaboration time.","Workshops provided most lasting value."
057,2,2,3,2,2,3,3,2,2,No particular highlight,"Expected cutting-edge AI methods but saw mostly standard approaches.","Disappointed by lack of methodological innovation. Most presentations applied existing computer vision or ML methods to bee data without advancing AI itself. This is fine but conference title suggested both AI innovation AND bee research. Also, validation methodology weak in many cases - need more rigorous standards for what counts as 'ready for deployment'.","Not worth international travel for most attendees."
058,5,5,5,5,5,5,4,5,5,Entire program,"Comprehensive coverage from sensing to analysis to ethics.","Nothing substantial. Minor timing issues but overall excellent.","Best investment of professional development time in years."
059,4,4,4,3,4,4,5,4,4,Dance communication analysis,"Prof. Foster's bee dance decoder revealing previously unknown dialects is genuinely novel finding.","Rooms too cold. Difficult to concentrate when shivering.","Good science, minor comfort issues."
060,3,3,3,3,3,3,3,3,3,Habitat design presentations,"Some interesting ideas but questioned feasibility.","Several presentations lacked cost analysis. Academic researchers optimizing for interesting problems rather than practical solutions. Dr. Martinez's urban planning work mentioned 'equivalent costs' to conventional approaches but no actual numbers. How much does genetic algorithm optimization cost? What's the labor required? These details matter for real-world adoption.","Needed more practical implementation focus."
061,5,5,5,5,4,5,5,5,5,Federated learning framework,"Dr. Tanaka's privacy-preserving global collaboration framework solves major barrier to international research.","More time for Q&A. Best discussions happened in hallways after talks, not during official time.","Groundbreaking work that will enable my international collaboration."
062,4,5,4,4,4,4,4,4,4,All three keynotes,"Keynote selection was excellent - complementary perspectives from different angles.","Conference dinner was overpriced. Should be included in registration or offered at reasonable rate.","Solid conference with excellent keynotes."
063,2,3,2,3,2,2,3,2,2,Nothing particularly memorable,"Forgettable conference overall.","Felt more like product showcase than scientific conference at times. TechHive Solutions and Habitat AI Inc. presentations were essentially sales pitches. Need clearer distinction between academic research and commercial product promotion. Also, several 'innovations' were just standard tech applied to bees - not actually innovative.","Would not attend again unless major changes to format."
064,5,5,4,5,5,5,5,5,5,Pollen analysis and honey quality,"The synergy between Dr. Green's pollen analysis and Dr. Sweet Analyst's honey prediction demonstrates power of integrated data.","Nothing major. Outstandingly well organized.","Every session provided valuable insights."
065,4,4,4,4,4,3,4,4,4,IoT and edge computing work,"Impressed by systems designed for real-world constraints - connectivity, power, weather, cost.","Accommodation recommendations were expensive. Would appreciate budget options in conference materials.","Strong practical focus appreciated."
066,3,4,3,3,3,3,3,3,3,Literature mining NLP,"Useful tool but unclear how accessible it will be to broader community.","Many sophisticated tools demonstrated but no discussion of availability, licensing, or support for researchers wanting to use them. Dr. Thompson's NLP pipeline sounds useful but will average researchers be able to deploy it? Or will it remain locked in original lab? Need more discussion of democratizing access to these tools.","Good ideas but accessibility concerns."
067,5,5,5,5,5,4,5,5,5,Ethics and governance discussions,"Critical perspective alongside technical work made this conference intellectually honest.","Extend conference. Too much content compressed into three days.","Rare combination of technical excellence and ethical awareness."
068,4,4,4,4,5,4,4,4,4,Hands-on workshop despite limitations,"Workshop provided good foundation despite being too basic.","Workshop promised 'working prototype systems' but we just configured software. Need actual hardware hacking session with sensors, cameras, etc.","Useful introduction for those new to IoT."
069,2,2,3,2,2,3,3,3,2,Green roof design poster,"One or two interesting ideas but overall disappointing.","Too much focus on technological sophistication, insufficient attention to ecological understanding. Dr. Green Designer's green roof AI seemed to treat plants as interchangeable optimization variables rather than living organisms with complex ecological relationships. Where were the botanists? The entomologists who study non-bee pollinators? The soil ecologists?","Needed more actual ecology in this ecology conference."
070,5,5,5,5,4,5,4,5,5,Opening and closing keynotes,"Bookending conference with Dr. Pollinator's vision and Dr. Ecosystem's ethics created perfect narrative arc.","More student participation. Seemed mostly established researchers.","Inspired and challenged in equal measure."
071,4,4,4,3,4,4,5,4,4,RFID social network analysis,"Prof. Network Mapper's findings about information hubs in foraging populations opens new research directions.","Parallel sessions meant missing interesting work. Perhaps provide detailed video recordings afterward.","Made several valuable research contacts."
072,3,3,3,3,3,3,3,3,3,Various presentations,"Nothing particularly stood out positively or negatively.","Average conference. Some good talks, some mediocre. Schedule was fine, venue was fine, food was fine. Nothing to complain about but nothing to rave about either.","Neutral experience."
073,5,5,5,4,5,5,5,5,5,Predictive analytics and time series forecasting,"The convergence on predictive modeling from multiple angles suggests this is high-impact direction.","Coffee could be better quality. Minor complaint.","Exactly what I hoped for from this conference."
074,4,5,4,4,4,4,4,5,4,Machine learning and ethics keynotes,"Two keynotes represented different but complementary perspectives on AI's role.","More representation from Global South. Most presenters from US, Europe, Australia. Where were the researchers from regions most affected by pollinator decline?","Content strong but geographic diversity lacking."
075,1,2,1,2,1,2,2,1,1,None,"Deeply problematic conference.","The assumption throughout was that more data, more monitoring, more sophisticated models will solve conservation problems. But we already know what kills pollinators. We have decades of research. What we lack is political will to regulate pesticides, transform agriculture, and prioritize biodiversity over profit. This conference is intellectual masturbation - brilliant people developing complex solutions to avoid confronting simple truths. The energy and funding poured into these AI systems would be better spent supporting farmers transitioning to ecological agriculture or fighting fossil fuel companies driving climate chaos.","Exemplifies academic detachment from real-world action."
076,5,5,5,5,5,5,5,5,5,Everything - comprehensive program,"Exceptional conference from start to finish.","Absolutely nothing. Perfect execution.","Will be referencing this conference in my work for years."
077,4,4,4,4,4,4,4,4,4,Automated counting and detection systems,"Multiple presentations showing automation can improve accuracy and consistency over human observation.","Sessions too tightly scheduled. Need buffer time between for overruns and transitions.","Good technical depth."
078,3,4,3,3,3,3,3,4,3,Keynotes and ethics workshop,"Appreciated that ethics wasn't afterthought but integrated throughout.","Registration materials unclear about what was included. Conference dinner, coffee breaks, materials - should be explicit.","Ethics integration appreciated but research quality variable."
079,5,5,5,5,5,4,5,5,5,Data Standards workshop,"Prof. Data Standard's workshop addressing interoperability will benefit entire field for years.","More practical technical training. Most workshops were discussion-based when hands-on practice would be valuable.","Infrastructure-building workshops like this are undervalued but crucial."
080,4,4,4,3,4,4,4,4,4,Multiple machine learning applications,"Seeing ML applied across different aspects of bee research showed breadth of possibilities.","Poster presenters should be more available. Some weren't present during designated times.","Solid conference. Would attend again."
081,2,3,2,2,2,3,2,2,2,Nothing memorable,"Underwhelming experience.","Conference tried to cover too much - monitoring, conservation, ethics, policy, commercial applications. Result was superficial treatment of everything. Would prefer focused conference doing one area well rather than scattered approach. Also, several presentations were essentially literature reviews with minimal original contribution.","Needed clearer focus and higher standards."
082,5,5,5,5,4,5,5,5,5,Toxicity modeling and IoT monitoring,"Combination of predictive risk assessment and real-time monitoring provides comprehensive protection.","Venue wireless connectivity spotty in some rooms.","Cutting-edge research with immediate practical value."
083,4,4,4,4,5,4,4,4,4,Collaborative frameworks workshop,"Workshop facilitating actual collaboration was more valuable than many presentations.","More diverse examples. Case studies heavily weighted toward Europe and North America.","Workshops exceeded expectations."
084,3,3,3,3,3,3,3,3,3,Genetic algorithms work,"Interesting optimization approach but limited validation.","Dr. Martinez's Barcelona results impressive but only three implementation sites mentioned. Need more validation before claiming general effectiveness. Also, the 'non-intuitive' arrangements discovered by algorithms - were these validated by ecologists? Or are we trusting optimization metrics that might miss important biological factors?","Interesting ideas but premature claims."
085,5,5,5,4,5,5,4,5,5,Acoustic monitoring approaches,"Multiple teams working on acoustic analysis from different angles suggests this is valuable modality.","More cross-talk between presenters working on similar topics. Felt like missed opportunity for synthesis.","Excellent range of methodological approaches."
086,4,5,4,4,4,4,4,4,4,All keynotes,"Three exceptional speakers providing different but complementary perspectives.","Schedule conflicts between interesting parallel sessions.","Keynotes alone worth the registration fee."
087,2,2,2,3,2,2,3,2,2,Smartphone citizen science app,"Skeptical of data quality from citizen science.","BeeWatch app might generate lots of data but how accurate? No discussion of validation or quality control beyond 'expert review of uncertain cases'. Also, gamification encouraging quantity over quality. And what happens when citizen scientists misidentify species? These errors could skew research conclusions but wasn't adequately addressed.","Concerns about data quality and validation."
088,5,5,5,5,5,5,5,5,5,Ethics framework and practical applications,"Perfect balance of technical innovation and ethical responsibility.","None. Exceeded expectations on all dimensions.","Transformative professional experience."
089,4,4,4,4,4,3,4,4,4,Computer vision applications,"Multiple CV applications showing this technology has matured enough for real deployment.","Lunch breaks too short. Barely enough time to eat, let alone network.","Solid technical conference."
090,3,4,3,3,3,3,3,3,3,Opening keynote,"Dr. Pollinator's keynote was excellent but rest was mixed.","Quality inconsistent. Keynotes were fantastic, some research presentations excellent, others felt unfinished or preliminary. Need more rigorous review process to ensure consistent quality across program.","Keynotes excellent, research presentations variable."
091,5,5,5,5,4,5,5,5,5,Integrated monitoring systems,"The progression from sensing to analysis to prediction to action planning was well demonstrated.","More time for informal interaction. Best insights came from conversations, not presentations.","Will fundamentally change how we approach monitoring in our lab."
092,4,4,4,4,5,4,4,4,4,Ethics and international collaboration workshops,"Workshops addressing practical implementation challenges were most valuable.","Provide more pre-conference materials. Arrived not knowing what to expect from different sessions.","Workshops were highlight of conference."
093,2,3,2,2,2,3,3,2,2,Wing morphometry analysis,"Limited practical value in most presentations.","Too specialized. Dr. Wing Analyst's morphometry work is fine for what it is but very narrow application. Conference felt like collection of very specific technical solutions without coherent vision of how they fit together or address major conservation challenges.","Lacked integrative perspective."
094,5,5,5,5,5,4,5,5,5,Closing ethics keynote,"Dr. Ecosystem's keynote addressing uncomfortable questions was courageous and necessary.","Ethics should be woven throughout, not just closing. Recommend opening with ethics framework next time.","Challenged assumptions in productive way."
095,4,4,4,3,4,4,4,4,4,Forecasting and predictive models,"Multiple predictive modeling approaches showing convergence on useful techniques.","Some presenters seemed more focused on ML sophistication than problem solving. Simplest effective solution should be goal.","Strong technical work but sometimes missed forest for trees."
096,3,3,3,3,3,3,3,3,3,Multiple presentations,"Attended but nothing particularly memorable.","Competent but uninspiring. Everything felt like incremental improvements on existing work rather than breakthroughs. Maybe that's just reality of science but conference promised more innovation than delivered.","Adequate professional development."
097,5,5,5,5,5,5,4,5,5,Entire integrated program,"Comprehensiveness across technical, ethical, and practical dimensions was exceptional.","Minor room temperature issues.","Best conference in my field I've attended."
098,4,5,4,4,4,4,5,4,4,Keynotes and selected research talks,"High quality presentations from established researchers.","More opportunities for early career researchers. Seemed dominated by senior faculty and industry. Where were the PhD students and postdocs doing innovative work?","Strong established researcher presence but could use more early career voices."
099,2,2,2,3,2,2,2,2,2,None particularly,"Disappointing across multiple dimensions.","Expected rigorous science but got a lot of hype. 'Revolutionary', 'breakthrough', 'unprecedented' thrown around too casually. When you actually examined methodology, much of it was standard approaches with modest improvements. Also, almost no discussion of negative results or failed approaches - where were those papers? Science needs honest reporting of what doesn't work, not just success stories.","Oversold and underdelivered."
100,5,5,5,5,5,5,5,5,5,Everything - transformative experience,"Cannot identify any weaknesses. Outstanding on every dimension.","Keep doing exactly what you're doing. This should be model for interdisciplinary AI conferences.","Life-changing conference. Already implementing ideas in research and recommending to everyone."`;
